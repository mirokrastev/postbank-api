"""
Django settings for postbank-api project.
...
if config('ENABLE_CORS', cast=bool):
    ...
    CORS_ORIGIN_WHITELIST = config('CORS_ORIGIN', '').split(',')


ROOT_URLCONF = 'postbank-api.urls'
...
WSGI_APPLICATION = 'postbank-api.wsgi.application'
